...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__User__copyloadda__08B54D69] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[User] ADD CONSTRAINT [PK__User__3214EC07F0EEA137] PRIMARY KEY CLUSTERED  ([Id])
GO
