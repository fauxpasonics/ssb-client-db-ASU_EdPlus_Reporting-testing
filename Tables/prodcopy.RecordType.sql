...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__RecordTyp__copyl__05D8E0BE] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[RecordType] ADD CONSTRAINT [PK__RecordTy__3214EC0787D1DB54] PRIMARY KEY CLUSTERED  ([Id])
GO
