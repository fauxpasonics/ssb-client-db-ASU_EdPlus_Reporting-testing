...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__RecordTyp__copyl__02FC7413] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[RecordType] ADD CONSTRAINT [PK__RecordTy__3214EC07917AFA61] PRIMARY KEY CLUSTERED  ([Id])
GO
