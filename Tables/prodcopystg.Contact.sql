...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Contact__copyloa__778AC167] DEFAULT (getdate()),
...
GO
ALTER TABLE [prodcopystg].[Contact] ADD CONSTRAINT [PK__Contact__3214EC0734ADE7B1] PRIMARY KEY CLUSTERED  ([Id])
GO
