...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Opportuni__copyl__0E6E26BF] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Opportunity] ADD CONSTRAINT [PK__Opportun__3214EC077830C0F4] PRIMARY KEY CLUSTERED  ([Id])
GO
