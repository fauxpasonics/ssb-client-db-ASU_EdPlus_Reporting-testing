...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Account__copyloa__7D439ABD] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[Account] ADD CONSTRAINT [PK__Account__3214EC072DA4530F] PRIMARY KEY CLUSTERED  ([Id])
GO
