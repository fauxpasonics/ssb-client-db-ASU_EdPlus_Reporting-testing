...
[FERPA_Trained__c] [bit] NULL,
[Information_Security_Training_Date__c] [date] NULL,
[Admin_Notes__c] [nvarchar] (1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[Voicemail_Skill_ID__c] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Agent_ID__c] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[copyloaddate] [datetime] NULL CONSTRAINT [DF__User__copyloadda__0B91BA14] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[User] ADD CONSTRAINT [PK__User__3214EC07078AB98F] PRIMARY KEY CLUSTERED  ([Id])
GO
